                ...
                <div class="card-body">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                        <div class="mb-3 mb-sm-0">
                            <h5 class="card-title fw-semibold">Comprobantes Generados Por Mes</h5>
                        </div>
                        <div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row alig n-items-start">
                                <div class="col-8">
                                    <h5 class="card-title mb-9 fw-semibold">Archivos generados</h5>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">
                                    Total<br /><small
                                        >(Comprobantes por mes)</small
                                    >
                                </th>
                                <th class="text-center">
                                    Total<br /><small
                                        >(Comprobantes a PSE-GIOR)</small
                                    >
                                </th>
                                <th class="text-center">
                                    Total<br /><small
                                        >(Comprobantes <br />notas de
                                        venta)</small
                                    >
                                </th>
