            ...
            <div class="card overflow-hidden">
              <div class="card-body p-4">
                ...
                <div class="row align-items-center">
                  <div class="col-8">
                    <h4 class="fw-semibold mb-3">{{ records.length }}</h4>
              ...
              <div class="card-body">
                <div class="row alig n-items-start">
                  <div class="col-8">
                    ...
                    <h4 class="fw-semibold mb-3">{{ discUsed }}</h4>
                    <a href="">
                      <div class="d-flex align-items-center pb-1">
                        <span
                          class="me-2 rounded-circle bg-light-danger round-20 d-flex align-items-center justify-content-center"
              ...
              <div class="card-body">
                <div class="row alig n-items-start">
                  <div class="col-8">
                    ...
                    <h4 class="fw-semibold mb-3">{{ iUsed }}</h4>
                    <a href="">
                      <div class="d-flex align-items-center pb-1">
                        <span
                          class="me-2 rounded-circle bg-light-danger round-20 d-flex align-items-center justify-content-center"
              ...
              <div class="card-body">
                <div class="row alig n-items-start">
                  <div class="col-8">
                    ...
                    <h4 class="fw-semibold mb-3">{{ storageSize }}</h4>
                    <div class="d-flex align-items-center pb-1">
                      <span
                        class="me-2 rounded-circle bg-light-danger round-20 d-flex align-items-center justify-content-center"
                      >
            ...
            <section class="card card-horizontal">
              ...
              <div class="card-body p-4 text-center">
                ...
                <div class="summary-footer">
                  <a class="text-muted text-uppercase" href="#client-list"
                    >Ver todos</a
                  >
                </div>
              </div>
                  ...
                  <div :data-value="discUsed" class="progress1 mx-auto">
                    ...
                    >
                      <div class="font-weight-bold">
                        {{ discUsed }}<small class="small"></small>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="widget-summary-col widget-summary-col-icon">
                <div class="summary-icon text-secondary">
                  <div class="progress1 mx-auto" data-value="100">
                    ...
                    >
                      <div class="font-weight-bold">
                        {{ storageSize }}<small class="small"></small>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th class="text-center">
                  Total<br /><small>(Comprobantes por mes)</small>
                </th>
                <th class="text-center">
                  Total<br /><small>(Comprobantes a PSE-GIOR)</small>
                </th>
                <th class="text-center">
                  Total<br /><small>(Comprobantes <br />notas de venta)</small>
                </th>
            ...
            <tbody>
              <tr v-for="(row, index) in records" :key="index">
                ...
                <td>{{ row.email }}</td>
                <td>
                  <span v-if="row.soap_type == '01'" class="badge badge-default"
                    >Demo</span
                  >
                  <span v-if="row.soap_type == '02'" class="badge badge-success"
                    >Producción</span
                  >
                  <span v-if="row.soap_type == '03'" class="badge badge-info"
                    >Interno</span
                  >
                </td>
                ...
                <td class="text-center">
                  ...
                  >
                    <el-badge
                      ...
                      class="item ml-4"
                      :type="
                        row.document_to_be_canceled == 0 ? 'primary' : 'danger'
                      "
                    >
                  ...
                  <strong>
                    <template v-if="row.sale_notes_quantity_if_include > 0">
                      {{
                        row.count_doc_month
                          ? row.count_doc_month +
                            row.sale_notes_quantity_if_include
                          : 0
                      }}
                      /
                    </template>
                ...
                <td class="text-center">
                  <strong>{{ row.current_count_doc_month }}</strong>
                </td>
                <td class="text-center">
                  <strong>{{ row.count_doc_pse }}</strong>
                </td>
                <td class="text-center">
                  <strong>{{
                    row.count_doc_month + row.count_sales_notes_month
                  }}</strong>
                </td>
                ...
                <td class="text-center">
                  <el-switch
                    ...
                    style="display: block"
                    @change="
                      changeLockedByColumn(row, 'locked_create_establishments')
                    "
                  ></el-switch>
                </td>
